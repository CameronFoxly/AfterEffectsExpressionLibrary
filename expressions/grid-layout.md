This expression can be used to layout a grid of objects.
...
You'll also want to create a null called "CONTROLLER" and add a slider called "padding" and pickwhip it in line 6 to control the grid's spacing. 
